class ZFE_DATA_GENERATOR_000258 definition
  public
  final
  create public .
...
CLASS ZFE_DATA_GENERATOR_000258 IMPLEMENTATION.


METHOD IF_OO_ADT_CLASSRUN~MAIN.
    INSERT ('zfe_atrav_000258') FROM (
        SELECT
          FROM /dmo/travel
          FIELDS
            uuid(  )      AS travel_uuid           ,
    ...
    dyn_table_name = | /dmo/booking    AS booking  |
                 && | JOIN  { 'zfe_atrav_000258' } AS z |
                 && | ON   booking~travel_id = z~travel_id |.

    " insert booking demo data
    INSERT ('zfe_abook_000258') FROM (
        SELECT
          FROM (dyn_table_name)
          FIELDS
...
*   We overwrite the existing airlines with ours
    UPDATE ('zfe_abook_000258') SET carrier_id = 'SW' WHERE carrier_id NOT IN ( 'AA', 'AZ', 'LH', 'JL' ).
    UPDATE ('zfe_abook_000258') SET carrier_id = 'GA' WHERE carrier_id = 'AA'.
    UPDATE ('zfe_abook_000258') SET carrier_id = 'FA' WHERE carrier_id = 'AZ'.
    UPDATE ('zfe_abook_000258') SET carrier_id = 'EA' WHERE carrier_id = 'LH'.
    UPDATE ('zfe_abook_000258') SET carrier_id = 'OC' WHERE carrier_id = 'JL'.
    COMMIT WORK.
...
*   insert the new table entries
    INSERT ('zfe_astat_000258') FROM TABLE @status_itab.
    COMMIT WORK.
...
*   insert the new table entries
    INSERT ('zfe_acarr_000258') FROM TABLE @carrier_itab.
    COMMIT WORK.

    " insert connection demo data
    INSERT ('zfe_aconn_000258') FROM (
        SELECT
          FROM /dmo/connection
          FIELDS
            carrier_id,
...
*   We overwrite the existing airlines with ours
    UPDATE ('zfe_aconn_000258') SET carrier_id = 'SW' WHERE carrier_id NOT IN ( 'AA', 'AZ', 'LH', 'JL' ).
    UPDATE ('zfe_aconn_000258') SET carrier_id = 'GA' WHERE carrier_id = 'AA'.
    UPDATE ('zfe_aconn_000258') SET carrier_id = 'FA' WHERE carrier_id = 'AZ'.
    UPDATE ('zfe_aconn_000258') SET carrier_id = 'EA' WHERE carrier_id = 'LH'.
    UPDATE ('zfe_aconn_000258') SET carrier_id = 'OC' WHERE carrier_id = 'JL'.
    COMMIT WORK.

    " insert flight demo data
    INSERT ('zfe_aflig_000258') FROM (
...
*   We overwrite the existing airlines with ours
    UPDATE ('zfe_aflig_000258') SET carrier_id = 'SW' WHERE carrier_id NOT IN ( 'AA', 'AZ', 'LH', 'JL' ).
    UPDATE ('zfe_aflig_000258') SET carrier_id = 'GA' WHERE carrier_id = 'AA'.
    UPDATE ('zfe_aflig_000258') SET carrier_id = 'FA' WHERE carrier_id = 'AZ'.
    UPDATE ('zfe_aflig_000258') SET carrier_id = 'EA' WHERE carrier_id = 'LH'.
    UPDATE ('zfe_aflig_000258') SET carrier_id = 'OC' WHERE carrier_id = 'JL'.
    COMMIT WORK.

*   For simplicity reasons we only use one currency (EUR)
    UPDATE ('zfe_abook_000258') SET flight_price = division( flight_price, 130, 2 )  where currency_code = 'JPY'.
    UPDATE ('zfe_atrav_000258') SET booking_fee = division( booking_fee, 130, 2 )  where currency_code = 'JPY'.
    UPDATE ('zfe_atrav_000258') SET total_price = division( total_price, 130, 2 )  where currency_code = 'JPY'.
    UPDATE ('zfe_abook_000258') SET flight_price = division( flight_price, 2, 2 )  where currency_code = 'SGD'.
    UPDATE ('zfe_atrav_000258') SET booking_fee = division( booking_fee, 2, 2 )  where currency_code = 'SGD'.
    UPDATE ('zfe_atrav_000258') SET total_price = division( total_price, 2, 2 )  where currency_code = 'SGD'.
    UPDATE ('zfe_atrav_000258') SET currency_code = 'EUR'.
    UPDATE ('zfe_abook_000258') SET currency_code = 'EUR'.
ENDMETHOD.
ENDCLASS.
